...
> [Download résumé as PDF ⬇️](/content/files/2026/06/jewei-resume-2026.pdf)

## Senior Laravel/PHP Backend Engineer

Senior software engineer specializing in Laravel/PHP backend systems, API architecture, payment integrations, legacy modernization, and engineering delivery practices. Experience spans SaaS, education technology, e-commerce, healthcare content systems, and commercial PHP products.

Strong senior individual contributor who partners with product, design, platform, and engineering teams to turn ambiguous requirements into pragmatic architecture, reliable APIs, production-ready software, and healthier delivery workflows.
...
- AI-assisted engineering for analysis, documentation, workflow efficiency, and problem-solving with latest harness tools
...
- Build and maintain the [core app](https://games.oneone.com) with Laravel, Filament, Tailwind CSS, Pest, and PostgreSQL.
...
### Principal Software Engineer, [ModeFair](https://modefair.com/?ref=jewei.net)
