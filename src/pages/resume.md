...
1. the best-in-the-market community software with Joomla CMS extension.
2. curated articles and news aggregators from healthcare professionals for pharmaceutical companies and healthcare institutions worldwide.
3. an e-commerce platform collaborated with more than 50 KOL and influencers.
4. and an award-winning learning platform for 10,000 Malaysian schools that made teaching and learning easy for teachers and students.
...
### Senior Software Engineer, [Oneverse](https://oneone.com/?ref=jewei.net)

2024 – Present

- Build the [core app](https://games.oneone.com) with Laravel, Filament, Inertia.js, Vue.js, Tailwind CSS.
- The Laravel expert in the team.
- Write feature and unit tests with Pest.

### Senior Backend Software Engineer, [femmily](https://femmily.com/?ref=jewei.net)
...
### Senior Software Engineer, [FrogAsia](https://frogasia.com/?ref=jewei.net)
...
- Involve in developing products: Lesson Planner app, Curriculum Designer, Boost app, Certificate app, Courses app, Workspaces, and analytic dashboard.
...
### Principle Software Engineer, [ModeFair](https://modefair.com/?ref=jewei.net)

2016 – 2018 · 2 yrs

- Design and architect the backend system and API for an e-commerce application, including features like campaign management, merchant onboarding, product listing, business reporting, and audit logs.
...
### Application Developer, [P\S\L Group](https://www.pslgroup.com/?ref=jewei.net)
...
- **Tools:** Drush, G Suite, SVN, PHP\_CodeSniffer, PHPUnit.

### Software Developer, [Stackideas](https://stackideas.com/?ref=jewei.net)
